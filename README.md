...
Load ESP-IDF environment in PowerShell:

```powershell
. ..\..\..\..\setup_esp_idf_env.ps1
```

Or add to your PowerShell profile for automatic loading (see [ENV_SETUP_README.md](../../../../ENV_SETUP_README.md))
...
# Flash only (replace COMX with your port, MUST use uppercase)
idf flash -p COMX

# Build and flash
idf build flash -p COMX

# Build, flash, and monitor
idf build flash monitor -p COMX
```

**Important:** Serial port must use UPPERCASE letters (COMX, not COMX)

**Legacy command (without environment setup):**
...
$env:IDF_PATH = "C:\Users\YOUR_USERNAME\esp\v5.5.1\esp-idf"
cd "D:\YourProjects\YourProjectName"
python.exe "C:\Users\YOUR_USERNAME\esp\v5.5.1\esp-idf\tools\idf.py" build flash -p COMX
```
